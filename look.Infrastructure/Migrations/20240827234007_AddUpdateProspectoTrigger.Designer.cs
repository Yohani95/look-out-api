...
namespace look.Infrastructure.Migrations
{
    ...
    [Migration("20240827234007_AddUpdateProspectoTrigger")]
    partial class AddUpdateProspectoTrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("look.domain.entities.prospecto.LlamadaProspecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.Property<bool>("RespondeLlamada")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("Id");

                    b.ToTable("LlamadaProspectos");
                });
            ...
            modelBuilder.Entity("look.domain.entities.prospecto.ReunionProspecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                    ...
                    b.Property<bool>("SolicitaPropuesta")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("Id");

                    b.ToTable("ReunionProspectos");
                });

            modelBuilder.Entity("look.domain.entities.prospecto.TipoContactoProspecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TipoContactoProspectos");
                });
            ...
            modelBuilder.Entity("look.domain.entities.prospecto.Prospecto", b =>
                {
                    ...
                    b.HasOne("look.domain.entities.prospecto.ContactoProspecto", "Contacto")
                        .WithMany("Prospectos")
